      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <Card className="border-zinc-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-medium text-zinc-800">Añadir Paciente</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="date" type="date" className="border-zinc-200 focus:border-zinc-400 focus:ring-zinc-400" />
              ...
              <Button className="w-full bg-zinc-900 hover:bg-zinc-800">GUARDAR PACIENTE</Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-200 bg-white shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-medium text-zinc-800">Pacientes Registrados</CardTitle>
            </CardHeader>
            <CardContent>
